...
import { FiMail, FiLinkedin, FiBriefcase, FiCalendar, FiBook, FiAward, FiStar, FiExternalLink } from 'react-icons/fi';

const StandardLayout = ({ portfolio, styles, isDarkMode }) => {
            ...
            <main className="max-w-6xl mx-auto py-20 px-6 space-y-32 relative">
                ...
                {content.languages && content.languages.length > 0 && (
                    <motion.section
                        ...
                        viewport={{ once: true, margin: "-100px" }}
                    >
                        <h2 className={`text-4xl font-bold mb-10 text-center ${styles.text}`}>Languages</h2>
                        <div className="flex flex-wrap justify-center gap-4">
                            {content.languages.map((language, index) => (
                                <motion.div
                                    ...
                                    viewport={{ once: true }}
                                    transition={{ delay: index * 0.05 }}
                                    className={`px-6 py-3 rounded-xl text-md font-semibold transition-all shadow-md group border cursor-default flex items-center gap-2
                                        ${isDarkMode
                                            ? 'bg-gray-800/80 border-gray-700 text-gray-200 hover:bg-gray-700 hover:border-indigo-500'
